# Available .DIRECT One-Word Domains (19,567)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-19%2C567%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **19,567 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 19,567 domains · **Median ask:** $20.01 · **High-demand under $2,500:** 0
...
| end.direct   | available | $14.98    | $53.98        | medium         | low    | 3      | namecheap         |
| fund.direct  | resell    | —         | —             | high           | low    | 4      | Dynadot Inc       |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 19,567 live domains                        |
...
> Unique Domains. *Available .DIRECT One-Word Domains*. Version 2026-09-07. Public GitHub extract for the exact Unique Domains search represented by this repository.
